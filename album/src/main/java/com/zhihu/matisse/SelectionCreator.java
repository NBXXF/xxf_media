...
public final class SelectionCreator {
     ...
     */
    SelectionCreator(Album matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
     ...
     * <p>
     * It's a redundant API with {@link Album#obtainResult(Intent)},
