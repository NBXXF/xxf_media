...
public final class SelectionCreator {
    private final AlbumLauncher mMatisse;
     ...
     */
    SelectionCreator(AlbumLauncher matisse, @NonNull Set<MimeType> mimeTypes, boolean mediaTypeExclusive) {
        mMatisse = matisse;
     ...
     * 1. {@link com.xxf.media.album.engine.impl.GlideEngine}
     * 2. {@link com.xxf.media.album.engine.impl.PicassoEngine}
     ...
     * <p>
     * It's a redundant API with {@link AlbumLauncher#obtainResult(Intent)},
